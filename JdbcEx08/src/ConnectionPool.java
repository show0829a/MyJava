...
public class ConnectionPool {
	...
	//접속
	public static ConnectionPool getInstatance (
			String url,
			String user,
			String password,
	...
	throws SQLException
	{
		...
		//초기 커넥션 개수를 각각의 ArrayList에 저장할 수 있도록 초기 커넥션 수만큼
		//ArrayList를 생성한다.
		free = new ArrayList<Connection>(initialCons);
		used = new ArrayList<Connection>(initialCons);
			
		// inicialCons 수만큼 Connection을 생성(free)한다.
	...
	private Connection getNewConnection() throws SQLException
	{
		...
		System.out.println("connet to " + numCons + " : " + con);
		//커넥션 생성 될 때마다 숫자가 증가한다.
		++numCons;
		return con;
	}
